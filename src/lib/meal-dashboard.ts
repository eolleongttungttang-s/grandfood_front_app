...
// records-view.tsx의 14일 그리드에서 날짜 칸 하나를 탭했을 때 그날 상세(끼니별 기록/반찬별
// 잔반율)를 보여주는 데 쓴다(2026-08-19 피드백) — deriveMealTones가 하루를 톤 하나로
// 뭉뚱그리며 버리는 dishes/mealType 등 원본 정보를 다시 꺼내 쓰는 용도다.
