// 날짜 문자열("YYYY-MM-DD") 요일 표시 — banchan-recommendation-calendar.tsx(월 달력 +
// 최근 목표 달성률 추이)와 records-view.tsx(최근 14일 섭취 기록의 날짜별 상세) 둘 다
// "이 날짜가 무슨 요일인지"를 한국어로 보여줘야 해서 하나로 뺐다(2026-08-19) — 따로 두면
// 나중에 한쪽만 고치고 잊어버리기 쉽다.
...
// 안 바뀜을 이미 전제하고 있었음, banchan-recommendation-calendar.tsx의 기존 formatDayLabel과
// 동일한 형식).
